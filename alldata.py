...
def main():
    ...
    if choice == "Upload audio":
        ...
        if audio_file is not None:
            ...
            ##############################################################################
            model = load_model("c:/Users/Lenovo/OneDrive/Documents/webUI/speech_audio.h5/",compile=False)
            ...
            data_fin, sample_rate_fin = librosa.load(
                "C:/Users/Lenovo/OneDrive/Documents/webUI/"+str(path))
            ...
            x_test = X1
            scaler = joblib.load("C:/Users/Lenovo/OneDriveDocuments/webUI/scaler.pkl1/")

            # Use the loaded scaler to transform data
            x_test = scaler.transform(x_test)
            x_test = np.expand_dims(x_test, axis=2)
            print('====================>1')
            path_checkpoint = "C:/Users/Lenovo/OneDrive/Documents/webUI/training_2/cp.ckpt/"
            model.load_weights(path_checkpoint)
            pred_test = model.predict(x_test)
            encoder_file = "C:/Users/Lenovo/OneDrive/Documents/webUI/encoder1.npy/"
